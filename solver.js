var inputElement = document.querySelector("input[name=captchacode]");
var label = inputElement.previousElementSibling;

label.innerHTML = "";

var scriptElement = document.createElement('script');
scriptElement.src = 'https://unpkg.com/tesseract.js@2.0.0/dist/tesseract.min.js';
scriptElement.onload = function() {
  ...
  async function start() {
    ...
    var captchaDecoded = data.text.replace(/\s/g, '')
    console.log("Captcha Decoded:", captchaDecoded);
    inputElement.value = captchaDecoded;
